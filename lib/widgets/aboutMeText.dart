...
class AboutMeText extends StatelessWidget {
  ...
  AboutMeText({Key? key, this.textAlign, required this.fontSize}) : super(key: key);
    ...
    return RichText(
      ...
      text: TextSpan(children: [
        TextSpan(
          ...
          style: MediaQuery.of(context).size.width < 600 ? _textStyle(fontSize, false) : _textStyle(fontSize + 2, false),
        ),
        TextSpan(
          text: "Student at\nVidyavardhini's College of Engineering and Technology, Vasai, Maharashtra\n\n",
          style: MediaQuery.of(context).size.width < 600 ? _textStyle(fontSize, true) : _textStyle(fontSize + 2, true),
        ),
        TextSpan(
